  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-wide">Add New Course</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Create a new academic program in the database</p>
        </div>
